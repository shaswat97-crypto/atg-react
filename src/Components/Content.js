          ...
          <div className="ctype">
            ...
            <div className="profilecont">
              ...
              <div className="shareimg">
                <img src={share} alt="" />
                <div className="eyetext">Share</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className={clicked ? "menu view" : "menu"}>
        ...
        <div className="ctext">
          <div className="ctype">
            ...
            <div className="cbody">
              <h1>
              Finance & Investment Elite Social Mixer @Lujiaui
              </h1>
              
              <div className={clicked ? "dotscont active" : "dotscont"}
                onClick={handleClick}>
                <div className="dots">...</div>
              </div>
            </div>
            ...
            <div className="ahembtn">Visit Website</div>
            <div className="profilecont">
              <div className="profile">
                <div className="pimg">
                  <img src={p2} alt="" />
